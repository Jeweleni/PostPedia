      ...
      <section className="relative w-full h-[800px] ">
        ...
        <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-center px-4 sm:px-8 lg:px-12">
          <div className="text-left">
            <h1
              className="text-white font-bold font-body text-2xl md:text-3xl lg:text-4xl xl:text-5xl leading-12 md:leading-16 lg:leading-20 xl:leading-24"
            >
              Welcome to PostPedia: A Haven for Text-Based Content
            </h1>
            <p
              className="text-white font-medium text-base font-body md:text-lg lg:text-xl xl:text-2xl leading-6 md:leading-9 lg:leading-12 xl:leading-14 mt-[24px]"
            >
          ...
          <div className="text-left flex flex-wrap justify-between items-center mt-[30px]">
            <div className="w-72 h-80 p-4 border border-gray-300 rounded-lg my-[30px] mx-auto gap-3">
              <Image
                ...
                alt='analytics image'
              />
              <h3 className="text-black font-body text-xl font-semibold leading-9 my-[12px]">Analytics</h3>
            ...
            <div className="w-72 h-80 p-4 border border-gray-300 rounded-lg my-[30px] mx-auto">
              <Image
                ...
                alt='analytics image'
              />
              <h3 className="my-[12px] text-black font-body text-xl font-semibold leading-9">Social interactions</h3>
              <p className="text-[#626262] font-body text-base font-normal leading-6">
            ...
            <div className="w-72 h-80 p-4 border border-gray-300 rounded-lg my-[30px] mx-auto">
              <Image
                ...
                alt='analytics image'
              />
              <h3 className="text-black font-body text-xl font-semibold leading-9 my-[12px]">Content creation</h3>
              <p className="text-[#626262] font-body text-base font-normal leading-6">
      ...
      <section className="bg-rgba-50">
        <div className="lg:flex lg:flex-row flex-col items-center justify-between lg:w-[85%] mx-auto px-5 py-20">
          ...
          <div className="lg:w-[65%] w-80% sm:mt-[15px] lg:text-left sm:text-center">
            ...
            <h3
              className="text-black font-body text-xl font-medium leading-9 mt-[48px] mb-[24px]"
            >
              Adebobola Muhydeen, 
              <span
                className="text-black font-body text-base font-normal leading-6 ml-[5px]"
              >
